class LegendsController < ApplicationController
  ...
  private
    ...
    def legend_params
      params.require(:legend).permit(:legend_name, :legend_desc, :legend_passive_name, :legend_passive_desc, :legend_ability_name, :legend_ability_desc, :legend_ult_name, :legend_ult_desc)
    end
end
